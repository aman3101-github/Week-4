package resumeanalysertestfile;
...
public class ResumeAnalyserTestFile {
    public static void main(String[] args) {
        System.out.println("Resume Screening System Testing");
